...
$('#search_box').keyup(function () {
  ...
  // $('#questions_cont').html(`<div class="mt-5 text-center">
  //   <div class="spinner-border text_grey mb-2"></div>
  //   <h4 class="font-weight-bold text_grey">Loading</h4>
  // </div>`)
  $('#questions_cont').html('')
  var i = 0
  for (let question_obj of all_questions) {
    if (question_obj.title.toUpperCase().indexOf(search_val.toUpperCase()) > -1) {
      i++
      var question_url = 'https://leetcode.com/problems/' + question_obj.titleSlug
      var tags_html = ''
      for (let tag of question_obj.tagsArray) {
